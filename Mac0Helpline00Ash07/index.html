...
<head>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"
            ...
            <!-- Global site tag (gtag.js) - Google Analytics -->
                        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-132655272-1"></script>
                        <script>
                          window.dataLayer = window.dataLayer || [];
                          function gtag(){dataLayer.push(arguments);}
                          gtag('js', new Date());

                          gtag('config', 'UA-132655272-1');
                        </script>
    ...
    <script type="text/javascript">
        ...
        var phone_number = phone + ' +1-888-988-1337 (Toll Free)';
        var phone_number2 = phone + ' +1-888-988-1337 (Toll Free)';
